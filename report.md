# TITLE: "Learning Analytics: Concepts, Methodologies, Tools, and Applications"
## CONCEPTS
| concept | explanation |
|---|---|
| Attention | The cognitive process of selectively concentrating on a particular aspect of the environment while ignoring other things. |
...
| Goal Oriented Visualizations | Visualizations that are designed to help users achieve specific goals. |
| Technical Infrastructure for Learning Analytics | The hardware, software, and networks that are needed to support learning analytics. |
| Learning Dashboards | Dashboards that provide learners with information about their progress and performance. |
| Learning Recommenders | Systems that recommend learning resources to learners. |
...
|---|---|---|
| Attention | Active_Data | Attention is a type of active data that is generated by students as they interact with learning materials. |
| Learning Analytics | Learning_Analytics | Learning analytics is the field of study that uses data to understand and improve learning. |
| Visualization | Visualization | Visualization is a technique that can be used to represent data in a way that makes it easier to understand. |
| Recommendation | Recommendation | Recommendation is a type of learning analytics that can be used to provide students with personalized learning experiences. |
| Goal Oriented Visualizations | Visualization | Goal oriented visualizations are a type of visualization that is designed to help students achieve specific goals. |
| Technical Infrastructure for Learning Analytics | Technology | The technical infrastructure for learning analytics includes the hardware, software, and networks that are needed to support learning analytics. |
| Learning Dashboards | Visualization | Learning dashboards are a type of visualization that provides learners with information about their progress and performance. |
| Learning Recommenders | Recommendation | Learning recommenders are a type of learning analytics that can be used to recommend learning resources to learners. |
| Data Based Research on Learning | Data | Data based research on learning is a type of research that uses data to understand and improve learning. |
## NOT FOUNDED
